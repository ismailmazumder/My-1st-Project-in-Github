        ...
        while truefalse:
            ...
            if ("Hi!" in a or "How are you?" in a or "Hi! how are you?" in a):
                ...
                while gameonoff:
                    ...
                    if poss == 20 or poss == 19 or poss == 18 or poss == 17 or poss == 16 or poss == 15 or poss == 10 or poss == 11 or poss == 12 or poss == 13 or poss == 14:
                ...
                i84 = True
                i83 = True
                allgussname = ['Ismail', 'Ullash', 'Mohith', 'Sadia', 'Ali', 'Nazmul','Samia','Sumi','Moon','Justin Bieber']
                i77 = random.choice(allgussname)
                print('Is your name : ',i77,'? If yes write y and press the enter button or no write n and press the enter button.')
                i79 = input("")
            ...
            #waiting
                ...
                print("Is your name is Hasina? If yes press y and if answar is no press n . If no name in my list please type incorrect and add your name on my list.")
                hasian = input("")
                ...
                while lotariname:
                    if ('y' in hasian):
                        ...
                        print("Is your name if yes press y and enter or no press n and hit the enter button =  " + str(lotari + 1) + ". " + allnameofuser[lotari])
                        #time.sleep(5)
                        tryyn = input('')
                        if ('y' in tryyn):
                            print("Thanks for using this program. Developed by Ismail Mazumder.")
                            lotariname = False
                        elif ('no my name' in tryyn or 'No my name is' in tryyn or 'incorrect' in tryyn or 'Incorrect' in tryyn):
            ...
            # send message 123
                ...
                while message <= messageno:
                    #print("Move the text cursor to where you want to send the message. Total time 10",timetimeinput,"second. \n")
                    if (message ==1):
